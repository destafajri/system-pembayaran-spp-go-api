...
func (siswa *siswaImplementation) GetListSiswaForAdmin(meta *meta.Metadata) ([]model.GetListSiswaResponse, int, error) {
...
func (siswa *siswaImplementation) getlistForAdminQuery(is_count bool, q *param.Query) (string, []interface{}, error) {
